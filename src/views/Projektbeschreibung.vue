        ...
        <b-container fluid>
          ...
          <span>Selected: {{ project.betreuenderDozent }}</span> -->
                ...
                <b-col sm="10">
                    ...
                    <b-row>
                        <b-form-input v-model="getKeywords" id="input-2">
                        </b-form-input>
                    </b-row>
                </b-col>
                ...
                <b-col sm="10">
                    ...
                    <b-row
                        v-for="mitglied in getGroupAdmins"
                        :key="mitglied.id"
                    >
                        <b-form-input
                            disabled
        ...
        <div>
            <b-row class="projectBeschreibung-buttons">
                ...
                <b-modal
                    ...
                    ><p>
                        Du kannst nicht mehr auf das Projekt zugreifen, wenn du
...
export default {
    ...
    methods: {
        ...
        findIndex() {
            ...
            for (
                let i = 0;
                i < this.$store.state.project.myProjects.length;
                i++
            ) {
                if (
        ...
        Solution from: https://stackoverflow.com/questions/15125920/how-to-get-distinct-values-from-an-array-of-objects-in-javascript*/
                ...
                this.$store
                    .dispatch("project/updateProject", updatedProj)
                    .then(() => {
    ...
    computed: {
        ...mapGetters({
            ...
            getCurrentUserInternalUID: "project/getCurrentUserInternalUID",
