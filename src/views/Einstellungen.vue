                ...
                <tr>
                    ...
                    <td>
                        <b-form-input
                            ...
                            v-on:input="
                                $v.getProfileData.anzahl_literaturreviews.$touch
                            "
                            v-bind:class="{
                                error: $v.getProfileData.anzahl_literaturreviews
                                    .$error,
                                valid:
                                    $v.getProfileData.anzahl_literaturreviews
                                        .$dirty &&
                                    !$v.getProfileData.anzahl_literaturreviews
                                        .$invalid,
                            }"
        ...
        addProfile() {
            ...
            if (!this.$v.$invalid) {
                var ausgabe = {
                    ...
                    anzahl_literaturreviews:
                        this.getProfileData.anzahl_literaturreviews,
