<template>
  <div>
    ...
    >
      ...
      <b-link :to= "{ name: 'ProjectSearch', params: { keyword2: keyword2 } }"> <b-icon icon="search"></b-icon> </b-link>
      </b-input-group-prepend>
      <b-form-input type="search" placeholder="Projekte durchsuchen" v-model= "keyword2"></b-form-input>
    </b-input-group>
