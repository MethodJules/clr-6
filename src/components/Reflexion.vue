                ...
                <b-container fluid>
                    ...
                    <b-row class="ich-tab">
                        ...
                        <b-form-textarea
                            ...
                            v-bind:class="{error: $v.berichten_reagieren.$error, valid: $v.berichten_reagieren.$dirty && !$v.berichten_reagieren.$invalid}"
                            id="textfeld-1"
                        ...
                        <b-form-textarea
                            ...
                            v-bind:class="{error: $v.in_bezug_setzen.$error, valid: $v.in_bezug_setzen.$dirty && !$v.in_bezug_setzen.$invalid}"
                            id="textfeld-2"
                        ...
                        <b-form-textarea
                            ...
                            v-bind:class="{error: $v.rekonstruieren.$error, valid: $v.rekonstruieren.$dirty && !$v.rekonstruieren.$invalid}"
                            id="textfeld-4"
                            placeholder="Rekonstruieren Sie zukünftiges Handeln in Bezug auf den Vorfall bzw. das Problem. Wie würden Sie beim nächsten Mal vorgehen? Welche Ansätze könnten funktionieren und wieso? Gibt es verschiedene Optionen, aus denen Sie wählen können? Welches Ergebnis erwarten Sie?">
                        ...
                        <b-col lg="4" class="pb-2"><b-button size="sm" to="/home">Zum Dashboard</b-button></b-col>
                        ...
                        <b-col lg="4" class="pb-2"><b-button size="sm" @click="addItem()">Speichern </b-button></b-col>
