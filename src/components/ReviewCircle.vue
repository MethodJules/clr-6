        ...
        data() {
            return {
                elements: [
                    ...
                    {
                        type: 'theme', angle: 321.42, label: 'Ziel und Umfang definieren', labelPos: 'right2',
                        text: 'Forschungsfrage, Artefakt und Umfang', textPos: 'rightText2', done: false
                    },
                    {
                        type: 'theme', angle: 12.84, label: 'Konzepte & Definition identifizieren', labelPos: 'right3',
                        text: 'Konzepte, Domänen und working definitions', textPos: 'rightText3', done: false
                    },
                    {
                        type: 'theme', angle: 64.26, label: 'Literatur suchen', labelPos: 'right4',
                        text: 'Suchstrategie, Kriterien und Durchführung', textPos: 'rightText4', done: false
                    },
                    {
                    ...
                    },
                    {
                        ...
                        text: 'Codingschema und Volltextanalyse', textPos: 'leftText2', done: false
                    },
                    
                    {
                        type: 'mode', angle: 218.52, label: 'Ergebnisse kommunizieren', labelPos: 'left3',
                        text: 'Ergebnisaufbereitung und -verbreitung', textPos: 'leftText3', done: false
                    },
                    /*
                    {
