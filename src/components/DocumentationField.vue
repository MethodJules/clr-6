<template>
    ...
    <b-row>
    <div class="card-body border border-dark">{{this.documentationList[0].documentation}}</div> <!--TODO: Bug hier wird der 6. Eintrag zwar aufgerufen, aber die eckigen Klammern sind da siehe http://localhost:8080/phasetemplate-->
