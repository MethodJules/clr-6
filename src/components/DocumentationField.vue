<template>
    ...
    <b-row>
    <div class="card-body border border-dark">{{getDocumentation}}</div> <!--TODO: Bug hier wird der 6. Eintrag zwar aufgerufen, aber die eckigen Klammern sind da siehe http://localhost:8080/phasetemplate-->
    ...
    <br>
    <TemplateButtons :inDoku="getDocumentation"></TemplateButtons>
